...
SLASH_VENTUREPLAN1, SLASH_VENTUREPLAN2 = "/adventurestan", "/advs"
function SlashCmdList.VENTUREPLAN(msg)
	...
	if v == "set-campaign-progress" then
		...
		print("|cff20a0ff/adventurestan |r|cffffffffset-campaign-progress|r |cff20ff20" .. c .. "|r|cffa0a0a0|||r|cff20ff20nil")
		return
	end
	print("|cff20a0ffVenture Plan |r|cffffffff" .. GetAddOnMetadata("Adventure Stan", "Version"))
end